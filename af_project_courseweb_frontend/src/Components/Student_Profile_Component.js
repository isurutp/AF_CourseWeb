...
import add_submission_student from "./Student/Add_Submission_Student_Component" ;
    ...
    render() {
        return(
            ...
            <div>
                ...
                <Route exact path={'/student/add_submission/:courseId'} component={add_submission_student}/>
            </div>
            </Router>
        )
    }
